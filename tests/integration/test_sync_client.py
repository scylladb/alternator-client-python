...
class TestRoutingScopes:
    ...
    def test_datacenter_scope_works(self) -> None:
        """Test datacenter-scoped routing against the provisioned topology."""
    ...
    def test_rack_scope_works(self) -> None:
        ...
        This test uses the datacenter and rack reported by the CCM cluster.
        """
...
class TestTLSConfiguration:
    """Test TLS configuration against CCM-generated certificates."""
