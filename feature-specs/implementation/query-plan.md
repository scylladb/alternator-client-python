...
replacement changes the URL scheme and authority while preserving the existing path and query;
Botocore subsequently signs and transmits the updated request.
...
| `QUERY-REQ-002` | [`handlers.py`](../../alternator/core/handlers.py), [`query_plan.py`](../../alternator/core/query_plan.py) | [`test_query_plan.py`](../../tests/unit/test_query_plan.py) | `conformant` |
| `QUERY-REQ-003` | [`query_plan.py`](../../alternator/core/query_plan.py), [`deterministic_rand.py`](../../alternator/core/deterministic_rand.py) | [`test_query_plan.py`](../../tests/unit/test_query_plan.py), [`test_deterministic_rand.py`](../../tests/unit/test_deterministic_rand.py) | `conformant` |
| `QUERY-REQ-004` | [`handlers.py`](../../alternator/core/handlers.py) | [`test_key_affinity.py`](../../tests/unit/test_key_affinity.py) | `conformant` |
...
| `QUERY-REQ-007` | [`handlers.py`](../../alternator/core/handlers.py), [`request.py`](../../alternator/core/request.py) | [`test_request_lifecycle.py`](../../tests/unit/test_request_lifecycle.py), [`test_async_client.py`](../../tests/integration/test_async_client.py) | `conformant` |
...
- `QUERY-REQ-005`: URL replacement, path/query preservation, retry reuse, body stability, and
  pre-signing order are implemented. Node-health attempt attribution is absent: the client does not
  record an in-flight endpoint or classify a response versus a pre-response transport failure
